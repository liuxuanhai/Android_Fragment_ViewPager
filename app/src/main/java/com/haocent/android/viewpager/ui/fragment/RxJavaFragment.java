...
import com.haocent.android.viewpager.ui.adapter.RxJavaAdapter;
...
public class RxJavaFragment extends Fragment {
    ...
    private RxJavaAdapter mAdapter;
    ...
    private void initView(View view) {
        RecyclerView recyclerView = view.findViewById(R.id.rcv_rxjava);
        mProgressBar = view.findViewById(R.id.progressbar);

        mAdapter = new RxJavaAdapter(getActivity());
    ...
    private void loadData() {
        Observable<List<RxJavaContributorsBean>> observable = mService.getRxJavaContributors();
        observable.subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<List<RxJavaContributorsBean>>() {
                    @Override
                    ...
                    @Override
                    public void onNext(List<RxJavaContributorsBean> rxJavaContributorsBeans) {
                        Log.d(TAG, "onNext: ");

                        mAdapter.setDataList(rxJavaContributorsBeans);
                    }
